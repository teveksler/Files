...
public class PurchaseOrderDAOTest {
	 ...
	 *
	 */
	private PurchaseOrderDAO dataStore;

	/**
	 * Instantiates a new PurchaseOrderDAOTest.
	 *
	 */
	...
	/**
	 * Method to test PurchaseOrder domain object.
	 *
	 */
	@Rollback(false)
	@Test
	 ...
	 */
	@Autowired
	public void setDataStore(PurchaseOrderDAO dataStore) {
