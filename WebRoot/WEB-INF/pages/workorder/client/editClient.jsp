...
<body>
	<div class='content'>
		...
		<form:form action="${pageContext.request.contextPath}/saveWorkOrderClient" method="POST" modelAttribute="client">
			<table id="viewTable" class="table table-bordered">
				<tbody>
					...
					<tr>
						...
						<td><form:select id="client_clientType" path="clientType" required="required" class="form-control" 
					...
					<tr>
						...
						<td><form:input type="text" required="required" class="form-control" 
								id="client_clientName" path="clientName" cssStyle="width:300px;"
								placeholder="Enter client name" /></td>
					</tr>
					<tr>
						<td><fmt:message key="client.clientphonenum.title" />:</td>
						<td><form:input id="client_clientPhoneNum" class="form-control" 
								path="clientPhoneNum" type="number" min="1"
								cssStyle="width:300px;" placeholder="Enter client phone number" /></td>
					</tr>
					<tr>
						<td><fmt:message key="client.clientext.title" />:</td>
						<td><form:input id="client_clientExt" path="clientExt" class="form-control" 
								cssStyle="width:300px;" type="number" min="1" pattern="[0-9]*"
								placeholder="Enter client phone extension" /></td>
					</tr>
					<tr>
						<td><fmt:message key="client.clientemail.title" />:</td>
						<td><form:input type="email" id="client_clientEmail" class="form-control" 
								path="clientEmail" cssStyle="width:300px;"
								placeholder="Enter client email" /></td>
					</tr>
					<tr>
						<td class="required"><fmt:message
								key="client.clientaddress.title" />:</td>
						<td><form:input required="required" id="client_clientAddress" class="form-control" 
								path="clientAddress" cssStyle="width:300px;"
								placeholder="Enter client address" /></td>
					</tr>
					<tr>
						<td class="required"><fmt:message
								key="client.clientcity.title" />:</td>
						<td><form:input required="required" id="client_clientCity" class="form-control" 
								path="clientCity" cssStyle="width:300px;"
								placeholder="Enter client city" /></td>
					</tr>
					<tr>
						<td class="required"><fmt:message
								key="client.postalcode.title" />:</td>
						<td><form:input required="required" id="client_postalCode" class="form-control" 
								path="postalCode" cssStyle="width:300px;"
					...
					<tr>
						...
						<td><form:input id="client_clientComment"
								path="clientComment" cssStyle="width:300px;" class="form-control" 
								placeholder="Add comment" /></td>
					</tr>
				</tbody>
			</table>
			<input type="hidden" name="workorder_workOrderId" value="${workorder_workOrderId}">
