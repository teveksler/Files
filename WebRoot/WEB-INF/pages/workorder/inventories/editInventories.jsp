...
<body>
	<div class='content'>
		...
		<form:form
			action="${pageContext.request.contextPath}/saveWorkOrderInventories"
				...
				<tbody>
					...
					<tr>
						...
						<td><form:input id="inventory_inventoryLocation"
								class="form-control" placeholder="Enter inventory item location"
			...
			<input type="hidden" name="workorder_workOrderId"
				value="${workorder_workOrderId}">
		</form:form>
		<br>
	</div>
	<script>
		$(document).ready(function() {
			...
			$("#cancel").click(function() {
				...
				alertify.error('Item was not saved!');
			});
		});
	</script>
</body>
