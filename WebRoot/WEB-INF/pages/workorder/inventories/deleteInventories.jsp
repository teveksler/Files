...
<body>
	<div class='content'>
		...
		<a id="delete" class="btn btn-success"
			href="${pageContext.request.contextPath}/deleteWorkOrderInventories?workorder_workOrderId=${workorder_workOrderId}&related_inventories_inventoryId=${inventory.inventoryId}&"><span
