...
<body>
	<div class="content">
		...
		<form:form action="${pageContext.request.contextPath}/saveWorkOrderEmployees"
			...
			<table id="viewTable" class="table table-bordered">
				<tbody>
					...
					<tr>
						...
						<td><form:input id="employee_employeeName"
								class="form-control" path="employeeName" type="text"
								required="required" cssStyle="width:300px;"
					...
					<tr>
						...
						<td><form:input id="employee_employeeEmail"
								class="form-control" path="employeeEmail"
								cssStyle="width:300px;" type="email"
								placeholder="Enter employee email" /></td>
					</tr>
					<tr>
						<td><fmt:message key="employee.employeecomment.title" />:</td>
						<td><form:input id="employee_employeeComment"
								class="form-control" path="employeeComment"
								cssStyle="width:300px;" placeholder="Enter employee comment" /></td>
					</tr>
				</tbody>
			</table>
