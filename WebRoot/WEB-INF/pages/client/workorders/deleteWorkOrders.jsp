...
<body>
	<div class='content'>
		<br>
		<h1>Confirm Work Order Delete</h1>
		...
		<a id="delete" class="btn btn-success"
			href="${pageContext.request.contextPath}/deleteClientWorkOrders?client_clientId=${client_clientId}&related_workorders_workOrderId=${workorder.workOrderId}&"><span
			class="glyphicon glyphicon-trash"></span> <fmt:message
				key="navigation.delete" /></a>	<a id="cancel" class="btn btn-danger"><span
