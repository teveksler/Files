...
<body>
	<div class="content">
		...
		<form:form
			action="${pageContext.request.contextPath}/saveClientWorkOrders"
				...
				<tbody>
					...
					<tr>
						...
						<td><form:input id="workorder_workOrderScope"
								required="required" placeholder="Enter work order scope"
								class="form-control" path="workOrderScope"
					...
					<tr>
						...
						<td><form:input id="workorder_workOrderAddress"
								required="required" placeholder="Enter work order address"
								class="form-control" path="workOrderAddress"
								cssStyle="width:300px;" /></td>
					</tr>
					<tr>
						<td class="required"><fmt:message
