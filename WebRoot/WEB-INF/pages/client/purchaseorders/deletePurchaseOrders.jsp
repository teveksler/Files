...
<head>
<title>View <fmt:message key="client.title" /> <fmt:message
...
<body>
	<div class='content'>
		<br>
		<h1>Confirm Purchase Order Delete</h1>
		<table id="viewTable" class="table table-bordered">
			<tbody>
				<tr>
					<td><fmt:message key="purchaseorder.purchaseorderid.title" />:
					</td>
				...
				<tr>
					<td><fmt:message key="purchaseorder.purchaseorderstatus.title" />:</td>
		...
		<a  id="delete"
			...
			href="${pageContext.request.contextPath}/deleteClientPurchaseOrders?client_clientId=${client_clientId}&related_purchaseorders_purchaseOrderId=${purchaseorder.purchaseOrderId}&"><span
			class="glyphicon glyphicon-trash"></span> Confirm Delete</a>	<a id="cancel" class="btn btn-danger"><span
