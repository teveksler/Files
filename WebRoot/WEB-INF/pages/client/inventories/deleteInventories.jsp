	...
	<div class='content'>
		...
		<table id="viewTable" class="table table-bordered">
			<tbody>
				...
				<tr>
					<td><fmt:message key="inventory.inventoryproductname.title" />:
					</td>
				...
				<tr>
					<td><fmt:message key="inventory.inventorystocklevel.title" />:
					</td>
				...
				<tr>
					<td><fmt:message key="inventory.inventorylowthreshold.title" />:
					</td>
					<td>${inventory.inventoryLowThreshold}</td>
				</tr>
				<tr>
					<td><fmt:message key="inventory.inventorylocation.title" />:
					</td>
		...
		<a id="delete" class="btn btn-success"
			href="${pageContext.request.contextPath}/deleteClientInventories?client_clientId=${client_clientId}&related_inventories_inventoryId=${inventory.inventoryId}&"><span
	...
	<script>
		$(document).ready(function() {
			...
			$("#cancel").click(function() {
				...
				alertify.error('Item was not deleted!');
			});
		});
	</script>
</body>
