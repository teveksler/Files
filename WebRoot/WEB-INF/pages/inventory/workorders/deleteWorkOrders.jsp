...
<body>
	<div class="content">
		<br>
		<h1>Confirm Delete Work Order</h1>
		...
		<a id="delete" class="btn btn-success"
			href="${pageContext.request.contextPath}/deleteInventoryWorkOrders?inventory_inventoryId=${inventory_inventoryId}&related_workorders_workOrderId=${workorder.workOrderId}&"><span
