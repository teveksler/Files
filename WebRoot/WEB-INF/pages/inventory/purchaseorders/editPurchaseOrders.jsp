...
<html>
<head>
<title>New/Edit New Purchase Order</title>
...
<body>
	<div class="content">
		...
		<form:form
			action="${pageContext.request.contextPath}/saveInventoryPurchaseOrders"
			...
			<table id="viewTable" class="table table-bordered">
				<tbody>
					...
					<tr>
						...
						<td><form:input required="required" id="purchaseorder_purchaseOrderAddress"
								path="purchaseOrderAddress" cssStyle="width:300px;" placeholder="Enter purchase order address" class="form-control" /></td>
					</tr>
					<tr>
						<td class="required"><fmt:message
								key="purchaseorder.purchaseordercreateddate.title" />:</td>
						<td><input required="required" id="purchaseorder_purchaseOrderCreatedDate"
							...
							style="width:300px;" placeholder="Enter created on date"/></td>
					</tr>
					<tr>
						<td class="required"><fmt:message
								key="purchaseorder.purchaseorderexpecteddate.title" />:</td>
						<td><input  required="required" id="purchaseorder_purchaseOrderExpectedDate"
					...
					<tr>
						...
						<td><input id="purchaseorder_purchaseOrderRecievedDate"
							...
							style="width:300px;" placeholder="Enter actual received on date" /></td>
					</tr>
					<tr>
						<td class="required"><fmt:message
								key="purchaseorder.purchaseorderstatus.title" />:</td>
						<td><form:select required="required" id="purchaseorder_purchaseOrderStatus" class="form-control"
								path="purchaseOrderStatus" cssStyle="width:300px;" placeholder="Select Status">
