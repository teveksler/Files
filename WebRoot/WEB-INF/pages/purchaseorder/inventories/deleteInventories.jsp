...
<body>
	<div class='content'>
	<br>
		<h1>Confirm Delete Inventory Item</h1>
		...
		<a id="delete" class="btn btn-success"
			href="${pageContext.request.contextPath}/deletePurchaseOrderInventories?purchaseorder_purchaseOrderId=${purchaseorder_purchaseOrderId}&related_inventories_inventoryId=${inventory.inventoryId}&"><span
			class="glyphicon glyphicon-trash"></span> Confirm Delete</a>
			<a
