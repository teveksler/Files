	...
	<div class="content">
		...
		<table id="viewTable" class="table table-striped table-bordered">
			<tbody>
				...
				<tr>
					<td><fmt:message
							key="client.clientphonenum.title" />:</td>
					<td>${client.clientPhoneNum} </td>
				</tr>
				<tr>
					<td><fmt:message
							key="client.clientext.title" />:</td>
					<td>${client.clientExt} </td>
				</tr>
				<tr>
					<td><fmt:message
							key="client.clientemail.title" />:</td>
				...
				<tr>
					<td><fmt:message
							key="client.clientcomment.title" />:</td>
		...
		<a id="delete"
			...
			href="${pageContext.request.contextPath}/deletePurchaseOrderClients?purchaseorder_purchaseOrderId=${purchaseorder_purchaseOrderId}&related_clients_clientId=${client.clientId}&"><span
